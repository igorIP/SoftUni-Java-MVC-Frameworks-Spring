...
import labdemo.repository.OfferRepository;
...
public class OfferServiceImpl extends BaseService<Offer, UUID, OfferRepository> implements OfferService {
    ...
    public <B extends Bindable<Offer>> boolean registerOffer(B bindingModel) {
        return super.create(bindingModel);
    }

    @Override
    public <V extends Viewable<Offer>>
    Optional<V> findOffer(OfferFindBindingModel bindingModel, Class<V> viewModelClass) {
